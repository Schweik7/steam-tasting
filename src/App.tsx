...
import { checkInvite, fetchMe, logout, steamLoginUrl } from './lib/api'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    // Re-validate a persisted invite code against the backend on load.
  ...
  async function generate() {
    if (!inviteValid && (!settings.base || !settings.key || !settings.model)) {
